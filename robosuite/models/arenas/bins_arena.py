...
class BinArena(Arena):
    """
    Workspace that contains one divided bin.
    ...
    def __init__(
        self, bin1_pos=(0.1, -0.5, 0.8), table_offset = (0, 0, 0.8), table_full_size=(0.39, 0.49, 0.82), table_friction=(1, 0.005, 0.0001)
    ):
        super().__init__(xml_path_completion("arenas/bin_arena.xml"))
    ...
    def configure_location(self):
        ...
        self.bin1_body.set("pos", array_to_string(self.bin1_pos))
